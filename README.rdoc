...
The metrics extension comes bundled with a version of Vanity for active record. You can
specify to use the system version of Vanity:

* gem install vanity
* add Radiant::Config['metrics.use_gem'] = true to config/environment.rb

If you configure to use the system Vanity you must configure its Redis connection
